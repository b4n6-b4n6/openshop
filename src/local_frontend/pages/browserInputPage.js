...
const browserInputPage = ({ defaultOnionHostname }) => document({
  ...
  body: (
    `<form action="/browser-input" method="post" class="contents" data-browse-form>
      ${appFrame({
        title: 'Browse Shop',
        ...
        content: (
          ...
          >
            ...
            >Paste the shop&apos;s onion address to connect over Tor, or scan its QR code.</p>
            ...
            <p
              data-qr-error
              role="alert"
              class="hidden text-[13px] text-danger"
            ></p>
          </div>
